...
Status: Done. Hosting and Firestore rules deployed. Live smoke test against real member/income data still needed before first active use (operational task for Treasurer).
